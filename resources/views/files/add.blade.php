        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             {!! Form::open(array('route' => ['files.store'],'class'=>'form-horizontal','method'=>'POST', 'files'=>true)) !!}

                <div class="card-body">
                  <div class="form-group">
                    <label for="file_name">Name</label>
                    <input type="text" name="name" class="form-control" id="file_name" placeholder="Enter Name">
                  </div>
                  <div class="form-group">
